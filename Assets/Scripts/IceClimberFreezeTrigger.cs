...
public class IceClimberFreezeTrigger : MonoBehaviour
{
    ...
    {
        if(col.gameObject.name != "IceClimbers" && col.gameObject.name != "Pink" && col.gameObject.name != "ground" && col.gameObject.tag != "freeze")
        {
